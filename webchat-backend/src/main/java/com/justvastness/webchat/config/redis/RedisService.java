...
public class RedisService {
    ...
    public RedisService(RedisTemplate<String, Object> redisTemplate, RedisTemplate<String, Object> redisTemplate2) {
     ...
     * @date 2020/12/15 4:51 下午
     **/
    public List<?> hMultiGet(String key, List<String> hashKey) {
     ...
     * @date 2020/12/15 4:51 下午
     **/
    public void hSetAll(String key, Map<String, ?> value, Long time, TimeUnit timeUnit) {
        opsForHash().putAll(key, value);
